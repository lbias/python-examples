# script to check if tip already submitted to @python_tip
from collections import namedtuple
from contextlib import closing
import codecs # defines base classes for standard python codecs and provides access to the internal python codec registry
